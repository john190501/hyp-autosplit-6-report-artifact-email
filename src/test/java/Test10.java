...
public class Test10
{
    ...
    {   ExtentReports extent = new ExtentReports("target/surefire-reports/html/extentReport.html");
        ExtentTest test10 = extent.startTest("demo application test 10-1", "To Do App test 1");

        driver.get(testURL);
        Thread.sleep(5000);

        test10.log(LogStatus.PASS, "URL is opened");
        WebDriverWait wait = new WebDriverWait(driver, 5);
        test10.log(LogStatus.PASS, "Wait created");
        ...
        for (int i = 1; i <= item_count; i++) {
            ...
            test10.log(LogStatus.PASS, "New item No. " + i + " is added");
            Thread.sleep(2000);
        }
        ...
        for (int i = 1; i <= totalCount; i++, remaining--) {
            ...
            Thread.sleep(500);
            test10.log(LogStatus.PASS, "Item No. " + i + " marked completed");
            ...
            if (!expectedText.equals(actualText)) {
                test10.log(LogStatus.FAIL, "Wrong Text Description");
                status = "failed";
            }
            Thread.sleep(500);

            test10.log(LogStatus.PASS, "Item No. " + i + " completed");
        }
