...
//    String testURL = "https://todomvc.com/examples/react/#/";
    ...
    public void testSetUp(String browser, String version, String platform, String resolution) throws Exception
    {
        ...
        capabilities.setCapability("build", "[HyperExecute - 14] Demonstration of the TestNG Framework");
        capabilities.setCapability("name", "[HyperExecute - 14] Demonstration of the TestNG Framework");
    ...
    public void test14_element_addition_1() throws InterruptedException
    {   ExtentReports extent = new ExtentReports("target/surefire-reports/html/extentReport.html");
        ExtentTest test1 = extent.startTest("demo application test 14-1", "To Do App test 1");
