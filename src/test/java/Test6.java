...
public class Test6
{
    ...
    public void testSetUp(String browser, String version, String platform, String resolution) throws Exception
    {
        ...
        capabilities.setCapability("build", "[HyperExecute - 6] Demonstration of the TestNG Framework");
        capabilities.setCapability("name", "[HyperExecute - 6] Demonstration of the TestNG Framework");
    ...
    {   ExtentReports extent = new ExtentReports("target/surefire-reports/html/extentReport.html");
        ExtentTest test6 = extent.startTest("demo application test 6-1", "To Do App test 1");

        driver.get(testURL);
        Thread.sleep(5000);

        test6.log(LogStatus.PASS, "URL is opened");
        WebDriverWait wait = new WebDriverWait(driver, 5);
        test6.log(LogStatus.PASS, "Wait created");
        ...
        for (int i = 1; i <= item_count; i++) {
            ...
            test6.log(LogStatus.PASS, "New item No. " + i + " is added");
            Thread.sleep(2000);
        }
        ...
        for (int i = 1; i <= totalCount; i++, remaining--) {
            ...
            Thread.sleep(500);
            test6.log(LogStatus.PASS, "Item No. " + i + " marked completed");
            ...
            if (!expectedText.equals(actualText)) {
                test6.log(LogStatus.FAIL, "Wrong Text Description");
                status = "failed";
            }
            Thread.sleep(500);

            test6.log(LogStatus.PASS, "Item No. " + i + " completed");
        }
